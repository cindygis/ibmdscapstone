...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='class', 
        title='Total Outcomes for Launches for {}'.format(entered_site))
        return fig
# TASK 4:
...
def get_scatter_plot(entered_site, entered_payload):
    ...
    fig = px.scatter(filtered_df[mask], x='Payload Mass (kg)', y='class',
                    color='Booster Version Category',title='Correlation between Payload and Success for {}'.format(entered_site))
    return fig
# Run the app
